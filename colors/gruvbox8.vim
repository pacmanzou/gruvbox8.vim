...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    let g:terminal_ansi_colors = ['#000000', '#cc241d', '#98971a', '#d79921',
    ...
    hi Search guifg=#fabd2f guibg=#000000 gui=reverse cterm=reverse
    ...
    hi NormalMode guifg=#a89984 guibg=#000000 gui=reverse cterm=reverse
    hi InsertMode guifg=#83a598 guibg=#000000 gui=reverse cterm=reverse
    hi ReplaceMode guifg=#8ec07c guibg=#000000 gui=reverse cterm=reverse
    hi VisualMode guifg=#fe8019 guibg=#000000 gui=reverse cterm=reverse
    hi CommandMode guifg=#d3869b guibg=#000000 gui=reverse cterm=reverse
    hi Warnings guifg=#fe8019 guibg=#000000 gui=reverse cterm=reverse
    if has('nvim')
    ...
    if get(g:, "gruvbox_plugin_hi_groups", 0)
      ...
      hi BufTabLineCurrent guifg=#000000 guibg=#a89984 gui=NONE cterm=NONE
      ...
      hi BufTabLineFill guifg=#000000 guibg=#000000 gui=NONE cterm=NONE
      hi CocErrorSign guifg=#fb4934 guibg=#000000 gui=NONE cterm=NONE
      hi CocWarningSign guifg=#fabd2f guibg=#000000 gui=NONE cterm=NONE
      ...
      hi CocSelectedText guifg=#3c3836 guibg=#000000 gui=NONE cterm=NONE
      ...
      hi CtrlPMode2 guifg=#000000 guibg=#83a598 gui=bold cterm=bold
      ...
      if get(g:, 'indent_guides_auto_colors', 0)
        if get(g:, 'gruvbox_invert_indent_guides', 0)
          hi IndentGuidesOdd guifg=#000000 guibg=#504945 gui=reverse cterm=reverse
          hi IndentGuidesEven guifg=#000000 guibg=#3c3836 gui=reverse cterm=reverse
        else
          hi IndentGuidesOdd guifg=#000000 guibg=#504945 gui=NONE cterm=NONE
          hi IndentGuidesEven guifg=#000000 guibg=#3c3836 gui=NONE cterm=NONE
        endif
      endif
    ...
    if get(g:, "gruvbox_filetype_hi_groups", 0)
      ...
      hi htmlBold guifg=fg guibg=#000000 gui=bold cterm=bold
      hi htmlBoldUnderline guifg=fg guibg=#000000 gui=bold,underline cterm=bold,underline
      hi htmlBoldItalic guifg=fg guibg=#000000 gui=bold,italic cterm=bold,italic
      hi htmlBoldUnderlineItalic guifg=fg guibg=#000000 gui=bold,italic,underline cterm=bold,italic,underline
      hi htmlUnderline guifg=fg guibg=#000000 gui=underline cterm=underline
      hi htmlUnderlineItalic guifg=fg guibg=#000000 gui=italic,underline cterm=italic,underline
      hi htmlItalic guifg=fg guibg=#000000 gui=italic cterm=italic
  ...
  hi ToolbarButton guifg=#000000 guibg=#bdae93 gui=bold cterm=bold
